...
PW_null<- timeacc_pw_model_sym(0.02,100,1,Timetree_0.8_painted1, Substree_0.8_0.02painted_null, Pseudotree_0.8_0.02painted_null_new,0.5)
PW_OC_0.5times<- timeacc_pw_model_sym(0.02,100,5,Timetree_0.8_painted1, Substree_0.8_0.02painted_null, Pseudotree_0.8_0.02painted_null_new,0.5)
PW_OC_0.6times<- timeacc_pw_model_sym(0.02,100,5,Timetree_0.8_painted1, Substree_0.8_0.02painted_null, Pseudotree_0.8_0.02painted_null_new,0.6)
PW_OC_0.7times<- timeacc_pw_model_sym(0.02,100,5,Timetree_0.8_painted1, Substree_0.8_0.02painted_null, Pseudotree_0.8_0.02painted_null_new,0.7)
PW_OC_0.8times<- timeacc_pw_model_sym(0.02,100,5,Timetree_0.8_painted1, Substree_0.8_0.02painted_null, Pseudotree_0.8_0.02painted_null_new,0.8)
PW_OC_0.9times<- timeacc_pw_model_sym(0.02,100,5,Timetree_0.8_painted1, Substree_0.8_0.02painted_null, Pseudotree_0.8_0.02painted_null_new,0.9) 
...
save.image("timemodel_PW_pdup0.8_sig0.02_plot_data1.rda")
...
## Saving data for further analyses and plotting
save.image("timemodel_PW_pdup0.8_sig0.02_plot_data_latest.rda")
