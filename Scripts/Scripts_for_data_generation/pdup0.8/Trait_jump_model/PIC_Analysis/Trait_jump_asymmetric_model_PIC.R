...
pdup<-0.8 ###Proportion of duplication events
...
test_asym_jump_PIC_mixed_null_0.8 <- asymmetric_jump_mixed (0.02, 100, Timetree_0.8_painted1, Substree_0.8_0.02painted_null, Pseudotree_0.8_0.02painted_null_new,0.3,0.3) 
test_asym_jump_PIC_mixed_oc_0.8 <- asymmetric_jump_mixed (0.02, 100, Timetree_0.8_painted1, Substree_0.8_0.02painted_null, Pseudotree_0.8_0.02painted_null_new,0.5,0.2) 

## Saving data for further analyses and plotting
save.image("Asym_jump_10000_0.8dup_0.02sig2_PIC_all.rda")
...
## Saving data for further analyses and plotting
save.image("Asym_jump_10000_0.8dup_0.02sig2_PIC_plot_data1.rda")

############ Analyses further ###############
name<-c("null","oc")
dff<-list(test_asym_jump_PIC_mixed_null_0.8,test_asym_jump_PIC_mixed_oc_0.8)
...
## Saving data 
save.image("Asym_jump_10000_0.8dup_0.02sig2_PIC_plot_data2.rda")
...
rm(dff)
rm(name)
rm(test_asym_jump_PIC_mixed_null_0.8)
rm(test_asym_jump_PIC_mixed_oc_0.8)

## Saving data for further analyses and plotting
save.image("Asym_jump_10000_0.8dup_0.02sig2_PIC_plot_data_latest.rda")
