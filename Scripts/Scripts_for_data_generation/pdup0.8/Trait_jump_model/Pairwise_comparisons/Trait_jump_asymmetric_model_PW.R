...
asymmetric_jump_mixed_pw <- function (sig2,ntips,Timetree,Substree,Pseudotree,pdup_jump,pspe_jump) { 
  ...
  {
    #calibrated_painted <-Psuedotree_0.8_0.02painted_null_new[[1]][[i]] 
...
test_asym_jump_pw_mixed_null_0.8 <- asymmetric_jump_mixed_pw(0.02, 100, Timetree_0.8_painted1, Substree_0.8_0.02painted_null, Pseudotree_0.8_0.02painted_null_new, 0.3, 0.3) 
test_asym_jump_pw_mixed_oc_0.8 <- asymmetric_jump_mixed_pw(0.02, 100, Timetree_0.8_painted1, Substree_0.8_0.02painted_null, Pseudotree_0.8_0.02painted_null_new, 0.5, 0.2) 

## Saving data for further analyses and plotting
save.image("Asym_jump_10000_0.8dup_0.02sig2_pw_all.rda")

############ Further analyses & plotting ###############
name<-c("null","OC")
dff<-list(test_asym_jump_pw_mixed_null_0.8,test_asym_jump_pw_mixed_oc_0.8)
...
rm(filename)
rm(best_fit_model)
rm(test_asym_jump_pw_mixed_null_0.8)
rm(test_asym_jump_pw_mixed_oc_0.8)

## Saving data for further analyses and plotting
save.image("Asym_jump_10000_0.8dup_0.02sig2_pw_plot_data_latest.rda")
