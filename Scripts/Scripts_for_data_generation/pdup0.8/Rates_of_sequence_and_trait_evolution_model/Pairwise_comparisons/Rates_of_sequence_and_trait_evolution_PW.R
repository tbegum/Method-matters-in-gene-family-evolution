...
load("Calibration_tree_painted_0.8_0.02two_ways_new.rda")
...
pdup<-0.8 ### Proportion of duplications
...
test_OC_pairwise_null_0.8<- asymmetric_function_pw(0.02, 100, 1, Timetree_0.8_painted1, Substree_0.8_0.02painted_null, Pseudotree_0.8_0.02painted_null_new)
test_OC_pairwise_frate_0.8<- asymmetric_function_pw(0.02, 100, 5, Timetree_0.8_painted1, Substree_0.8_0.02painted_frate_OC, Pseudotree_0.8_0.02painted_frate_OC_new)
test_OC_pairwise_ftrait_0.8<- asymmetric_function_pw(0.02, 100, 1, Timetree_0.8_painted1, Substree_0.8_0.02painted_ftrait_OC, Pseudotree_0.8_0.02painted_ftrait_OC_new)
test_OC_pairwise_OC1_0.8<- asymmetric_function_pw(0.02, 100, 8, Timetree_0.8_painted1, Substree_0.8_0.02painted_OC1, Pseudotree_0.8_0.02painted_OC1_new)
test_OC_pairwise_OC2_0.8<- asymmetric_function_pw(0.02, 100, 8, Timetree_0.8_painted1, Substree_0.8_0.02painted_OC2, Pseudotree_0.8_0.02painted_OC2_new)
test_OC_pairwise_OC3_0.8<- asymmetric_function_pw(0.02, 100, 2, Timetree_0.8_painted1, Substree_0.8_0.02painted_OC3, Pseudotree_0.8_0.02painted_OC3_new)

## Saving data for further analyses and plotting
save.image("Asym_PW_pdup0.8_sig0.02_all.rda")
...
rm(Substree_0.8_0.02painted_ftrait_OC)
rm(Substree_0.8_0.02painted_frate_OC)
rm(Substree_0.8_0.02painted_OC1)
rm(Substree_0.8_0.02painted_OC2)
rm(Substree_0.8_0.02painted_OC3)
rm(Pseudotree_0.8_0.02painted_null_new)
rm(Pseudotree_0.8_0.02painted_ftrait_OC_new)
rm(Pseudotree_0.8_0.02painted_frate_OC_new)
rm(Pseudotree_0.8_0.02painted_OC1_new)
rm(Pseudotree_0.8_0.02painted_OC2_new)
rm(Pseudotree_0.8_0.02painted_OC3_new)

## Saving data for further analyses and plotting
save.image("Asym_PW_pdup0.8_sig0.02_plot_data1.rda")

############ Analyses further ###############
name<-c("null","ftrait","frate","OC1","OC2","OC3")
dff<-list(test_OC_pairwise_null_0.8,test_OC_pairwise_ftrait_0.8,test_OC_pairwise_frate_0.8,test_OC_pairwise_OC1_0.8,test_OC_pairwise_OC2_0.8,test_OC_pairwise_OC3_0.8)
...
for(x in 1:length(dff))
{
  ...
  label_p1<-NULL
  label_p<-NULL
  label_p1<-as.numeric(strsplit(Pval,"p = ")[[1]][2]) ## For pdup<-0.8
...
rm(filename)
rm(best_fit_model)
rm(test_OC_pairwise_null_0.8)
rm(test_OC_pairwise_frate_0.8)
rm(test_OC_pairwise_ftrait_0.8)
rm(test_OC_pairwise_OC1_0.8)
rm(test_OC_pairwise_OC2_0.8)
rm(test_OC_pairwise_OC3_0.8)

## Saving data for further analyses and plotting
save.image("Asym_PW_pdup0.8_sig0.02_plot_data_latest.rda")
