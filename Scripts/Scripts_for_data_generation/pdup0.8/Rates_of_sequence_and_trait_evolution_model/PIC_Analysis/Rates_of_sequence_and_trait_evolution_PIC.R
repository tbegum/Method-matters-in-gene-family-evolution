...
test_OC_null_0.8 <- asymmetric_function_PIC(0.02, 100, 1, Timetree_0.8_painted1, Substree_0.8_0.02painted_null, Pseudotree_0.8_0.02painted_null_new) 
test_OC_ftrait_0.8 <- asymmetric_function_PIC(0.02, 100, 1, Timetree_0.8_painted1, Substree_0.8_0.02painted_ftrait_OC, Pseudotree_0.8_0.02painted_ftrait_OC_new) 
test_OC_frate_0.8 <- asymmetric_function_PIC(0.02, 100, 5, Timetree_0.8_painted1, Substree_0.8_0.02painted_frate_OC, Pseudotree_0.8_0.02painted_frate_OC_new) 
test_OC_OC1_0.8 <- asymmetric_function_PIC(0.02, 100, 8, Timetree_0.8_painted1, Substree_0.8_0.02painted_OC1, Pseudotree_0.8_0.02painted_OC1_new) 
test_OC_OC2_0.8 <- asymmetric_function_PIC(0.02, 100, 8, Timetree_0.8_painted1, Substree_0.8_0.02painted_OC2, Pseudotree_0.8_0.02painted_OC2_new) 
test_OC_OC3_0.8 <- asymmetric_function_PIC(0.02, 100, 2, Timetree_0.8_painted1, Substree_0.8_0.02painted_OC3, Pseudotree_0.8_0.02painted_OC3_new) 

## Saving data for further analyses and plotting
save.image("Asym_PIC_pdup0.8_sig0.02_all.rda")
...
## Saving data for further analyses and plotting
save.image("Asym_PIC_pdup0.8_sig0.02_plot_data1.rda")

############ Analyses further ###############
name<-c("null","ftrait","frate","OC1","OC2","OC3")
dff<-list(test_OC_null_0.8,test_OC_ftrait_0.8,test_OC_frate_0.8,test_OC_OC1_0.8,test_OC_OC2_0.8,test_OC_OC3_0.8)
...
save.image("Asym_PIC_pdup0.8_sig0.02_plot_data2.rda")
...
rm(name)
rm(test_OC_null_0.8)
rm(test_OC_ftrait_0.8)
rm(test_OC_frate_0.8)
rm(test_OC_OC1_0.8)
rm(test_OC_OC2_0.8)
rm(test_OC_OC3_0.8)

## Saving data for further analyses and plotting
save.image("Asym_PIC_pdup0.8_sig0.02_plot_data_latest.rda")
