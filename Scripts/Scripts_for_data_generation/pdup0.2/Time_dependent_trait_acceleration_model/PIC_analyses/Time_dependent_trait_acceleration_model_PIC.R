...
load("Calibration_tree_painted_pdup0.2_sig0.02_NULL_new.rda")
...
pdup<-0.2 ###Proportions of duplication
...
#For a uniform null
PIC_null<- timeacc_model_sym(0.02,100,1,Timetree_0.2_painted1, Substree_0.2_0.02painted_null, Pseudotree_0.2_0.02painted_null_new,0.5)

## Trait accelerates until 50% time since oldest duplication 
PIC_OC_0.5times<- timeacc_model_sym (0.02,100,5,Timetree_0.2_painted1, Substree_0.2_0.02painted_null, Pseudotree_0.2_0.02painted_null_new,0.5) 

## Trait accelerates until 60% time since oldest duplication
PIC_OC_0.6times<- timeacc_model_sym (0.02,100,5,Timetree_0.2_painted1, Substree_0.2_0.02painted_null, Pseudotree_0.2_0.02painted_null_new,0.6) 

## Trait accelerates until 70% time since oldest duplication
PIC_OC_0.7times<- timeacc_model_sym (0.02,100,5,Timetree_0.2_painted1, Substree_0.2_0.02painted_null, Pseudotree_0.2_0.02painted_null_new,0.7)

## Trait accelerates until 80% time since oldest duplication
PIC_OC_0.8times<- timeacc_model_sym (0.02,100,5,Timetree_0.2_painted1, Substree_0.2_0.02painted_null, Pseudotree_0.2_0.02painted_null_new,0.8) 

## Trait accelerates until 90% time since oldest duplication
PIC_OC_0.9times<- timeacc_model_sym (0.02,100,5,Timetree_0.2_painted1, Substree_0.2_0.02painted_null, Pseudotree_0.2_0.02painted_null_new,0.9)        
...
save.image("Sym_timemodel_10000_0.2dup_0.02sig2_PIC_all.rda")
...
save.image("time_model_10000_0.2dup_0.02sig2_PIC_plot_data2.rda")
...
## Saving data for backup
save.image("time_model_10000_0.2dup_0.02sig2_PIC_plot_data_latest.rda")
