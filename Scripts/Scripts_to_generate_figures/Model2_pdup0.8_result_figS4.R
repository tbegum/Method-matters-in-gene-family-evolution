...
load("Asym_PIC_pdup0.8_sig0.02_plot_data_latest.rda")
load("Asym_PW_pdup0.8_sig0.02_plot_data_latest.rda")


png("Pdup0.8_all_in_one.png", width=1500, height=1000)
par(mfrow=c(3,4))
## Plotting results altogether
p1_pic_model2<-PIC_plot_0.8_null + 
...
p3_pic_model2<-PIC_plot_0.8_ftrait + 
...
p4_pw_model2<- PW_plot_0.8_ftrait + 
...
p5_pic_model2<-PIC_plot_0.8_frate + 
...
p6_pw_model2<- PW_plot_0.8_frate + 
...
p7_pic_model2<-PIC_plot_0.8_OC1 + 
...
p9_pic_model2<-PIC_plot_0.8_OC2 + 
...
p11_pic_model2<-PIC_plot_0.8_OC3 + 
