...
load("Asym_jump_10000_0.5dup_0.02sig2_PIC_plot_data_latest.rda")
load("Asym_jump_10000_0.5dup_0.02sig2_pw_plot_data_latest.rda")


png("jump_0.5dup_model3.png", width=800, height=600)
par(mfrow=c(2,2))
## Plotting results altogether
p1_pic_model3<-jump_model_PIC_plot_0.5_null + 
...
p2_pw_model3<-PW_plot_jump_model0.5_null+ 
...
p3_pic_model3<-jump_model_PIC_plot_0.5_oc + 
...
p4_pw_model3<- PW_plot_jump_model0.5_OC+ 
